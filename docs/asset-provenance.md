...
| `Assets/Textures/station_floor_{albedo,normal}.png` | Procedurally generated (custom C# script, not AI-generated) | Project-owned | 2026-07-13 | Cool blue-grey panel pair, ~1m tiles, clean (no grunge) — Station floor |
| `Assets/Textures/station_wall_{albedo,normal}.png` | Procedurally generated (custom C# script, not AI-generated) | Project-owned | 2026-07-13 | Cool blue-grey panel pair, ~2m tiles, clean (no grunge) — Station walls |
| `Assets/Textures/station_ceiling_{albedo,normal}.png` | Procedurally generated (custom C# script, not AI-generated) | Project-owned | 2026-07-13 | Cool blue-grey panel pair, ~1.3m tiles, clean (no grunge) — Station ceiling |
