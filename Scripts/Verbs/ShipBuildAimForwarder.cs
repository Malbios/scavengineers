...
/// <summary>Attaches to a pre-authored wall panel (WallNorth, MidWallA, ...) so aiming directly
/// at an existing wall's face also resolves to that ship's ShipBuildTarget, not just aiming at
/// the Floor next to it. Player-built wall segments don't need this — their collider is already
/// a child of the same body as ShipBuildTarget.</summary>
