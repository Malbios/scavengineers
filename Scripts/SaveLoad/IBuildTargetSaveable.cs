...
/// <summary>A second, narrow save contract alongside <see cref="ISaveable"/> — that one stays
/// bool-only, so a ShipBuildTarget's freely-placed conduit/wall state (a list of tiles/edges, not
/// a single flag) gets its own interface.</summary>
